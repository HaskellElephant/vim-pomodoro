...
function! pomodorohandlers#pause(name)
  ...
  if exists("g:pomodoro_log_file")
    ...
    nmap <buffer> <leader>q :exe "!echo '" . join(getline(1,'$'), "\n") .
      \ " minutes' >> " . g:pomodoro_log_file<CR> ZQ
  endif
